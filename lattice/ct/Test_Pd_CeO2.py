...
p = np.array(p)
print(p)
sites = p[[5, 7, 9, 11, 12, 13, 14, 15, 16, 17, 18, 19]]
cell = slab.get_cell()[0:2, 0:2]
...
workingdir = '.'
KMC_lat.lattice_matrix = slab.get_cell()[0:2, 0:2]/2
KMC_lat.site_type_names = ['C', 'T']
KMC_lat.site_type_inds = [1,1,1,1,1,1,1,1, 2,2,2,2]
...
plt.savefig(os.path.join('.', 'Pd_kmc_lattice_ct.png'))
plt.close()
