...
atoms *= (3, 1, 1) #Duplicate object in the x direction so that cropping gives a better 'extended surface' look

#Arguments for POV-Ray file
pov_args = {
...
povray_name = '{}_clean.pov'.format(file_name).replace('CONTCAR', 'PR')
write(povray_name, atoms, **pov_args)
