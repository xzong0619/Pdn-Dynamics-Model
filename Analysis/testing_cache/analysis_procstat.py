...
'''
x = pspec.read_Single_Procstat(fldr)
x.Freqs()
freq_vecs = x.event_freqs
'''

x = pspec.read_Multiple_Procstat(10, fldr)
freq_vecs = x.ave_procstat_freqs
dspec.PlotFreqs(freq_vecs) #, fname = os.path.join(Parent_dir, 'elem_step_freqs.png'))
