...
n = 5
Pd5 = Parallel_growth(n, ni_u, new_H, new_wt_i)
Pd5.unique()
ni_u = Pd5.mi_u
new_H = Pd5.H_u
new_wt_i = Pd5.wt_i_u
...
n = 6
Pd6 = Parallel_growth(n, ni_u, new_H, new_wt_i)
Pd6.unique()
ni_u = Pd6.mi_u
new_H = Pd6.H_u
new_wt_i = Pd6.wt_i_u
...
n = 7
Pd7 = Parallel_growth(n, ni_u, new_H, new_wt_i)
Pd7.unique()
ni_u = Pd7.mi_u
new_H = Pd7.H_u
new_wt_i = Pd7.wt_i_u
...
'''
n = 8
Pd8 = Parallel_growth(n, ni_u, new_H, new_wt_i)
Pd8.unique()
ni_u = Pd8.mi_u
new_H = Pd8.H_u
new_wt_i = Pd8.wt_i_u
...
n = 9
Pd9 = Parallel_growth(n, ni_u, new_H, new_wt_i)
Pd9.unique()
ni_u = Pd9.mi_u
new_H = Pd9.H_u
new_wt_i = Pd9.wt_i_u
...
n = 10
Pd10 = Parallel_growth(n, ni_u, new_H, new_wt_i)
Pd10.unique()
ni_u = Pd10.mi_u
new_H = Pd10.H_u
...
H_m = new_H[2] # mother cluster graph
G_m = nx.Graph(H_m)
G_s = G_m.subgraph([1, 2, 8])
list(G_s.edges)
'''
'''
n = 3
...
n = 5
old_edge = [(1, 2), (1, 3) ,(2, 3) ,(2, 4) ,(3, 4)]
old_wt_i = [2]

n = 6
old_edge = [(1,2), (1,3) ,(2,3) ,(2,4) ,(3,4) ,(3,5) ,(4,5)]
old_wt_i = [2, 4]

n = 7
old_edge = [(1, 2), (1, 3), (2, 3), (2, 4), (3, 4), (3, 5), (4, 5), (6, 1), (6, 3)]
old_wt_i =  [1, 2 ,4]

n = 8
nhx = 1
old_edge = [(1, 2),(1, 3),(2, 3),(2, 4),(3, 4),(3, 5),(4, 5),(6, 1),(6, 3),(7, 3),(7, 5),(6, 7)] #hexagonal
old_wt_i = [5, 1, 2, 4, 8, 9];
